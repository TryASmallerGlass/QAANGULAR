import { Directive, ElementRef, Input, Renderer2 } from '@angular/core';
 	...
 	@Directive({ selector: '[appTooltip]', standalone: true }) export class TooltipDirective { 
    
    @Input('appTooltip') tooltipText!: string; tooltipElement = this.renderer.createElement('span');
